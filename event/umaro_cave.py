...
class UmaroCave(Event):
    ...
    def character_mod(self, character):
        ...
        self.dialogs.set_text(dialog.UMARO_CAVE_CARVING, "Touch the eye of the carving?<line><choice> Yes<line><choice> No<end>")
    ...
    def item_mod(self, item):
        ...
        self.dialogs.set_text(dialog.UMARO_CAVE_CARVING, "Remove the item from the eye of the carving?<line><choice> Yes<line><choice> No<end>")
