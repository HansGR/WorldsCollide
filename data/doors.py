...
class Doors():
    ...
    def mod(self):
        ...
        [map1, zones, zone_counts] = self.map_doors()
    ...
    def map_doors(self):
        ...
        for R in self.room_doors:
            ...
            zones.append([R])
            zone_counts.append(self.room_counts[R])
        door_zones = {}
        ...
        while len(doors) > 0:
            ...
            if len(to_force) > 0:
                ...
                # Connect all remaining doors, following the rule that
    ...
    def map_oneways(self, zones, zone_counts):
        ...
        nib_rooms = {}
        for R in self.room_doors:
            nobs.extend(self.room_doors[R][1])
            for nob in self.room_doors[R][1]:
                nob_rooms[nob] = R
            nibs.extend(self.room_doors[R][2])
