...
room_data = {
    ...
    # Composite room for isolated Dream Maze (-rdm iso): one pit entrance from 421, locked trap exit from 429
    'ruin-stooge-maze' : [ [], [], [6845], [], {('cd1', 'cd2'): [2070]}, 1], # Dream Maze (isolated)
