...
VECTOR_FULL_HEAL_USED = 0x149 # custom, -nfh: set after using full heal in Vector once
...
GOT_FALCON = 0x0cd
SCHOOL_LIMITED_HEALS_1 = 0x0ce # custom, -nfh: top bit of Narshe school bucket drink counter
SCHOOL_LIMITED_HEALS_2 = 0x0cf # custom, -nfh: bottom bit of Narshe school bucket drink counter
...
KEFKA_TOWER_LEFT_SWITCH = 0x088         # custom, ruination: left switch on map 0x151 is pressed
KEFKA_TOWER_RIGHT_SWITCH = 0x08a        # custom, ruination: right switch on map 0x151 is pressed
