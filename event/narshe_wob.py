...
class NarsheWOB(Event):
    ...
    def ruination_mod(self):
        ...
        AREA_CLUES = {
            ...
            'UmarosCave': "The air from this doors sometimes smells… terrible!<end>",
            ...
            'VeldtCave': "A hunter came, talking about dragons.<end>",
            ...
            'ZoneEater': "This rock seems unstable. Watch out for cave-ins!<end>",
