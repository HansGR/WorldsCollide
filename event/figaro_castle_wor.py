...
class FigaroCastleWOR(Event):
    ...
    def add_gating_condition(self):
        if self.args.npc_dialog_tips:
            self.dialogs.set_text(dialog.FIGARO_CAVE_SIEGFRIED, "I won't budge from this spot until you have recruited <EDGAR>!<end>")
        else:
            self.dialogs.set_text(dialog.FIGARO_CAVE_SIEGFRIED, "SIGFRIED: Pretty dangerous from here on. Wait here.<end>")
