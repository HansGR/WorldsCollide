"""Isolated dream maze randomizer (-maze iso; rewrite Stage D milestone 5).

Port of legacy _randomize_isolated_maze: random door/trap matchings over
...
rooms are round-trippable from it). Unlike legacy, the chosen entry pit
