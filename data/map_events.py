...
class LongMapEvents():
    ...
    def addLongEvents(self):
        ...
        # (This is Lenophis' code implementing long events, the event equivalent of long exits)
        # "I make my hook at C0/BCAA, it's an LDA $82 followed by ASL A"
        # "obviously change the addresses ($F40000, currently) for where you want to put them"
        # "after that, just add them like you would anything else"
        # "you'll obviously need to add in the pointers and do the math"
        ROM_OFFSET = 0xC00000
